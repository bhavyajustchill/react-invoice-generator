...
const InvoiceGenerator = () => {
  ...
  const uuidGen = () => Math.random().toString(36).substring(2) + Date.now().toString(36);
  ...
  const [invoices, setInvoices] = useState(
    localStorage.getItem("invoices") ? JSON.parse(localStorage.getItem("invoices")) : []
  );
  ...
  const [invoice, setInvoice] = useState({
    ...
    dueDate:
      defaultSettings?.autoDueDate === true && defaultSettings?.autoDueDays > 0
        ? new Date(
            new Date().setDate(new Date().getDate() + defaultSettings?.autoDueDays)
          ).toLocaleDateString("en-CA")
        : "",
    invoiceFrom: defaultSettings?.invoiceFrom ?? "",
    invoiceTo: defaultSettings?.invoiceTo ?? "",
    items: [blankItem],
  ...
  const getSubtotal = (items) =>
    items.reduce((sum, item) => Number(sum) + Number(item.amount), 0).toFixed(2);

  const getTotal = (items, discounts, shipping) =>
    (getSubtotal(items) - Number(discounts || 0) + Number(shipping || 0)).toFixed(2);
  ...
  const addItem = () => setInvoice((prev) => ({ ...prev, items: [...prev.items, blankItem] }));
      ...
      <div className="row mt-3">
                  ...
                  <div className="col-md-6">
                    {imgSrc !== "" && (
                      <div className="position-relative">
                        <img src={imgSrc} className="mr-3 rounded preview-image" alt="" />
                        <button
                          type="button"
                          title="Remove logo"
                        ...
                        <div className="row">
                          ...
                          <div className="col-6">
                            <div className="form-floating mb-3">
                              ...
                              />
                              <label htmlFor={`floatingInputQty${index}`}>Quantity</label>
                            </div>
                          </div>
                          <div className="col-6">
                            <div className="form-floating mb-3">
                          ...
                          <div className="col-6">
                            <div className="input-group input-group-sm">
                              ...
                              <div className="input-group-text pe-1 ps-1">%</div>
                            </div>
                          </div>
                          <div className="col-6">
                            <div className="form-floating">
            ...
            <div className="row g-3">
              ...
              <div className="col-lg-5">
                <div className="row mb-2">
                  <label className="col-sm-3 col-form-label fw-semibold">Subtotal</label>
                ...
                <div className="row mb-2">
                  <label htmlFor="discounts" className="col-sm-3 col-form-label">
                    Discounts
                  </label>
                  <div className="col-sm-9">
                    <input
        ...
        <div className="col-lg-2">
          <div className="d-grid gap-2 mb-2">
            <button type="button" className="btn btn-primary btn-block" onClick={saveInvoice}>
              Save Invoice
            </button>
          </div>
          <div className="d-grid gap-2 mb-2">
          ...
          <div className="mb-3">
            <h6>
              My Invoice <span className="badge bg-primary text-white">{invoices.length}</span>
              <button
                type="button"
                title="New Invoice"
                    ...
                    <div className="dropdown float-end">
                      <button
                        className={`btn btn-sm ${
                          item.uuid === uuid ? "btn-outline-light" : "btn-secondary"
                        }`}
                        type="button"
